/**
 *  This script removes unrounded values and NaN's from the allYieldsArray.json
 */
...
allYieldsArray.forEach(dateArray=>dateArray
		       .slice(1).forEach(durationArray=>durationArray
					 .forEach((durationValue, index, array)=>{
					     !durationValue || durationValue === 'NaN'?
                             array[index] = null :
                             array[index] = (Math.round(100 * durationValue) / 100);
					 })));
